...
if (defined('IS_INNER_APP')) {
    $LBD_Resource_Url = $CI_Base_Url . 'index.php/botdetect/captcha_resource/get/';
} else {
...
$LBD_CaptchaConfig->HandlerUrl = $CI_Base_Url . 'index.php/botdetect/captcha_handler/index';
