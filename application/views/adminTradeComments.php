<?php $title = "Admin Verify Comments - GirlsTrade"; 
  include("header.php"); ?>
<div id="wrapper">
  <!-- /.header -->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-9 page-content">
           <div class="inner-box">
            <h2 class="title-2"><i class="icon-star-circled"></i> <?php echo $this->lang->line("approvePostComment"); ?> </h2>
              <form name="myForm" action="<?php echo base_url().MY_PATH;?>getAdmin/updateTradeComments" method="POST">
            		...
            		foreach($itemList as $id=>$row)
                  	{
                        ...
                        echo "</label>";
                      	echo "</div></td>";
                    	echo "<td style=\"width:20%\">seller: $from, buyer: $to</td>";
