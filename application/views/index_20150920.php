      ...
      <div class="row">
    	...
    	<div class="col-sm-9 page-content col-thin-right">
          <div class="inner-box category-content">
            <h2 class="title-2"><?php echo $this->lang->line("Index_Find_Under_Listing");?></h2>
             <div class="row">
             <?php 
    	     $count=0;
    	     $total=0;
            ...
            foreach ($AllCategory as $id=>$value)
            {
            	...
            	if($value[0]->level==1)
            	{
            		...
            		echo "<h3 class=\"cat-title\"><img src=$imageIcon alt='' height='30' width='30'>$name $postCount";
            	...
            	{
            		echo  "<li> <a href='$path'>$name</a><span class=\"count\">$postCount</span></li>";
            ...
            ?>
                ...
                <h2 class="title-2"><?php echo $this->lang->line("Interested_Listings");?> 
            ...
            <div class="inner-box relative">
                <h2 class="title-2"><?php echo $this->lang->line("Hot_Listings");?> 
                ...
                if($popularLocation1<>null)
                {
                	foreach ($popularLocation1 as $id=>$value)
	                {
	                	...
	                	$path=base_url().MY_PATH."getCategory/getAll/1/0/$value->locationID";
                  		echo "<li> <a href='$path'>$name $postCount</a></li>";
	                }
                }
                ?>
                 </ul>
        ...
        <div class="col-sm-3 page-sidebar col-thin-left">
          <aside>
            ...
            <div class="inner-box">
              <h2 class="title-2"><?php echo $this->lang->line("Popular_Categories");?> </h2>
                ...
                <div class="iconbox-wrap">
                          <div class="iconbox">
                            ...
                            <div class="iconbox-wrap-content">
                              <h5><span><?php echo $indexstat[0]->trustedseller;?></span> </h5>
                              <div  class="iconbox-wrap-text"><?php $this->lang->line("Trusted_Seller");?></div>
                            </div>
                          </div>
  							<!-- /..iconbox -->
                     </div><!--/.iconbox-wrap-->
            ...
            <div class="col-sm-3 col-xs-6 col-xxs-12">
            	<div class="iconbox-wrap">
                          <div class="iconbox">
                            ...
                            <div class="iconbox-wrap-content">
                              <h5><span><?php echo $indexstat[0]->category;?></span> </h5>
                              <div  class="iconbox-wrap-text"><?php $this->lang->line("Categories");?></div>
                            </div>
                          </div>
  							<!-- /..iconbox -->
                     </div><!--/.iconbox-wrap-->
            ...
            <div class="col-sm-3 col-xs-6  col-xxs-12">
            	<div class="iconbox-wrap">
                          <div class="iconbox">
                            ...
                            <div class="iconbox-wrap-content">
                              <h5><span><?php echo $indexstat[0]->location;?></span> </h5>
                              <div  class="iconbox-wrap-text"><?php $this->lang->line("Location");?></div>
                            </div>
                          </div>
  							<!-- /..iconbox -->
                     </div><!--/.iconbox-wrap-->
            ...
            <div class="col-sm-3 col-xs-6 col-xxs-12">
            	<div class="iconbox-wrap">
                          <div class="iconbox">
                            ...
                            <div class="iconbox-wrap-content">
                              <h5><span><?php echo $indexstat[0]->facebookfans;?></span> </h5>
                              <div  class="iconbox-wrap-text"> <?php $this->lang->line("Facebook_Fans");?></div>
                            </div>
                          </div>
  							<!-- /..iconbox -->
                     </div><!--/.iconbox-wrap-->
