          ...
          <div class="inner-box category-content panel-bevel">
            ...
            foreach ($AllCategory as $id=>$value)
            {
            	...
            	if($value[0]->level==1)
            	{
            		...
            		echo "<h3 class=\"cat-title\"><img  style=\"margin:0px; padding:0px;\"  src=$imageIcon alt='' height='30' width='30'><a  style=\"margin:0px; padding:0px;\"  href='$path'>$name $postCount</a>";
            		...
            		echo "<ul class=\"cat-collapse collapse in cat-id-$total\">";
            			...
            			echo "<div class=\"cat-list\">";
            			echo "<h3 ><img style=\"margin:0px; padding:0px;\"  src=$imageIcon alt='' height='30' width='30'><a  style=\"margin:0px; padding:0px;\" href='$path'>$name $postCount</a>";
