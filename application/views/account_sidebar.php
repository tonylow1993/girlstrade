...
<!--                 </div> -->
				<div class="collapse-box">
                  ...
                  <a id="menuTitle" data-toggle="collapse"  href="#ProfileMenuAccount">
                  <span id="menuTitle"><i class="icon-user-woman"></i><?php echo $AccountTabName;?> 
                  </span>
                  </a>
                  <a id="menuTitle" class="pull-right" data-toggle="collapse"  href="#ProfileMenuAccount"><span id="menuTitle"><i class="fa fa-angle-down"></i></span></a></h5>
                ...
                <div class="collapse-box">
                  <h5 class="collapse-title"> 
                  <a id="menuTitle" data-toggle="collapse"  href="#ProfileMenuEvaluate">
                  <span id="menuTitle">
                  <i class="icon-clipboard"></i><?php echo $this->lang->line("menuEvaluation");?> 
                  </span>
                  </a>
                  <a id="menuTitle" class="pull-right" data-toggle="collapse"  href="#ProfileMenuEvaluate">
                  <span id="menuTitle">
