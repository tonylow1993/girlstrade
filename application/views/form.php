      ...
      <div class=" col-lg-8">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"> <a data-toggle="collapse"  href="#collapse2" class="collapseWill"> Radio/checkbox <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a> </h4>
          </div>
        ...
        <div class="panel panel-default ">
          <div class="panel-heading">
            <h4 class="panel-title"> <a data-toggle="collapse"  href="#collapse4" class="collapseWill"> Select <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a> </h4>
          </div>
        ...
        <div class="panel panel-default ">
          <div class="panel-heading">
            <h4 class="panel-title"> <a data-toggle="collapse"  href="#collapse5" class="collapseWill"> Button <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a> </h4>
          </div>
              ...
              <form class="form-horizontal">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <button id="button1id" name="button1id" class="btn btn-success">Success Button</button>
                      <br>
                      <br>
                      <button id="button2id" name="button2id" class="btn btn-danger">Danger Button</button>
                      <br>
                      <br>
                      <button id="button2id" name="button2id" class="btn btn-default">default Button</button>
                      <br>
                      <br>
                      <button id="button2id" name="button2id" class="btn btn-info">info Button</button>
                      <br>
                      <br>
                      <button id="button2id" name="button2id" class="btn btn-primary">primary Button</button>
                      <br>
                      <br>
                      <button id="button2id" name="button2id" class="btn btn-warning">warning Button</button>
                    </div>
                  </div>
                </fieldset>
              </form>
