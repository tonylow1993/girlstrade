                ...
                if($result<>null)
            	{
            		$rowCount=0;
                  	foreach($result as $id=>$row)
                  	{
                		...
                		echo "<tr ".$readflag." >";
                    	echo "<td style=\"width:20%\" class=\"center-text\">$from";
                    	$rowCount=$rowCount+1;
...
<!--            </div> -->
            ...
            <textarea style="vertical-align: top; horizontal-align: left; resize:none;" class="form-control"  id="message-text"  maxlength="<?php echo DESCLENGTHININBOX;?>"  rows="5" columns="30"  name="message-text"  placeholder="Your message here.." data-placement="top" data-trigger="manual"></textarea>
          </div>
      ...
      <div class="modal-body">
        <form role="form" id="item" method="post" action="<?php echo base_url(); echo MY_PATH;?>messages/replyMessage/<?php echo $postID;?>/<?php echo $messageID;?>/inbox">
          ...
          <div class="form-group">
            ...
            <textarea style="vertical-align: top; horizontal-align: left; resize:none;" class="form-control"  rows="5" columns="30" maxlength="<?php echo DESCLENGTHININBOX;?>"  required="true" id="message-text" name="message-text"  placeholder="Your message here.." data-placement="top" data-trigger="manual"></textarea>
          </div>
          <div class="form-group">
