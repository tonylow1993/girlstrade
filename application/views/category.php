<?php $title = $keywords=="0"?"":trim($keywords);  include("header.php");?>
<!-- CSS WHEEL SLIDER -->
              ...
              <div class="locations-list  list-filter margin-top-30">
                ...
                <form role="form"  id="priceForm" class="form-inline "  onSubmit="return priceSetup()"  action="<?php echo base_url().MY_PATH.'getCategory/getAll/1/'.$catID_.'/'.$locID_.'/'.$keywords.'/0/'.$minPrice.'/'.$maxPrice.'/'.$activeTab.'/'.$sortByType.'/'.$sortByPrice.'/'.$sortByDate;?>" method="POST">  
                  <div class="margin-top-30">
                      ...
                      <input type="number" placeholder="20000 " id="maxPrice"  
                      value=<?php if($maxPrice>0) echo $maxPrice;?>  
                      name="maxPrice" max="20000"   class="form-control price">
					  
					  <script type="text/javascript">
						var html5Slider = document.getElementById('price-slider');

						noUiSlider.create(html5Slider, {
							start: [ <?php if($minPrice>0) echo $minPrice; else echo 20;?>, <?php if($maxPrice>0) echo $maxPrice; else echo 20000;?> ],
							connect: true,
							range: {
								'min': 20,
								'max': 20000
          ...
          <div class="locations-list  list-filter">
               ...
               <form role="form"  id="priceForm1" class="form-inline modalBody"  onSubmit="return priceSetup1()"  action="<?php echo base_url().MY_PATH.'getCategory/getAll/1/'.$catID_.'/'.$locID_.'/'.$keywords.'/0/'.$minPrice.'/'.$maxPrice.'/'.$activeTab.'/'.$sortByType.'/'.$sortByPrice.'/'.$sortByDate;?>" method="POST"> 
                  <div class="margin-top-20">
                      ...
                      <span id="menubarTitle"> — </span>
                      <input type="number" placeholder="20000 " id="maxPrice1"  
                      value="<?php if($maxPrice>0) echo $maxPrice;?>" 
                      name="maxPrice1" max="20000"   class="form-control price">
					  <script type="text/javascript">
						var html5Slider1 = document.getElementById('price-slider1');


						noUiSlider.create(html5Slider1, {
							start: [ <?php if($minPrice>0)echo $minPrice; else echo 20;?>, <?php if($minPrice>0)echo $maxPrice; else echo 20000;?> ],
