        ...
        <div class="col-sm-12 col-md-9 page-content col-thin-left" style="margin-bottom: 30px;">
          ...
          <div class="tab-box "> 
              ...
              <ul class="nav nav-tabs add-tabs" id="ajaxTabs" role="tablist">
                ...
                <a href="<?php echo base_url().MY_PATH.'getCategory/getAll/'.$pageNum.'/'.$catID_.'/'.$locID_.'/'.$keywords.'/0/'.$minPrice.'/'.$maxPrice.'/allAds/'.$sortByType.'/'.$sortByPrice.'/'.$sortByDate;?>"  id="allAds2" name="allAds2"  role="tab" data-toggle="tab">
                ...
                <a href="<?php echo base_url().MY_PATH.'getCategory/getAll/'.$pageNum.'/'.$catID_.'/'.$locID_.'/'.$keywords.'/0/'.$minPrice.'/'.$maxPrice.'/newAds/'.$sortByType.'/'.$sortByPrice.'/'.$sortByDate;?>" id="newAds2" name="newAds2"  role="tab" data-toggle="tab">
                ...
                <a href="<?php echo base_url().MY_PATH.'getCategory/getAll/'.$pageNum.'/'.$catID_.'/'.$locID_.'/'.$keywords.'/0/'.$minPrice.'/'.$maxPrice.'/usedAds/'.$sortByType.'/'.$sortByPrice.'/'.$sortByDate;?>" id="usedAds2" name="usedAds2"  role="tab" data-toggle="tab" >
