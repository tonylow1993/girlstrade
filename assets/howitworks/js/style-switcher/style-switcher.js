...
function changeColor(color){
	...
	$(".styler_infograph").removeClass('visible');
	$(".easy-pie-chart.styler_infograph").data('easyPieChart', '');
	$(".styler_infograph").attr('data-color', color);
